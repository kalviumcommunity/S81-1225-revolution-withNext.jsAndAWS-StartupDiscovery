        ...
        <article className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-zinc-700 dark:text-zinc-300 leading-relaxed">
              StartupDiscovery is a platform designed to bridge the gap between innovative
              startups and the resources they need to succeed. We believe every great idea
              deserves to be discovered, and every entrepreneur deserves a chance to shine.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <h3 className="text-lg font-semibold mb-2">🚀 Startup Showcase</h3>
                <p className="text-zinc-600 dark:text-zinc-400">
                  Present your startup to a global audience of investors, partners, and early adopters
                </p>
              </div>
              <div className="p-6 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <h3 className="text-lg font-semibold mb-2">💡 Discovery Feed</h3>
                <p className="text-zinc-600 dark:text-zinc-400">
              ...
              <div className="p-6 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700">
                ...
                <p className="text-zinc-600 dark:text-zinc-400">
                  Connect with founders, vote on ideas, and participate in discussions
                </p>
              </div>
              <div className="p-6 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700">
                <h3 className="text-lg font-semibold mb-2">📊 Analytics & Insights</h3>
                <p className="text-zinc-600 dark:text-zinc-400">
                  Track performance metrics and gain valuable feedback on your startup
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-zinc-700 dark:text-zinc-300 leading-relaxed mb-4">
              StartupDiscovery is built with modern, enterprise-grade technologies to ensure
              performance, scalability, and reliability:
            </p>
            <ul className="list-disc list-inside space-y-2 text-zinc-700 dark:text-zinc-300">
              <li>
                <strong>Next.js 15 App Router</strong> - Hybrid rendering with SSG, SSR, and ISR
              </li>
              <li>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  Pre-rendered at build time for maximum performance. Perfect for content that
                  rarely changes.
                </p>
              </div>
              <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <p className="text-sm text-green-800 dark:text-green-200">
                  Static with periodic updates (every 60 seconds). Balances performance with
                  freshness.
                </p>
              </div>
              <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg border border-purple-200 dark:border-purple-800">
                ...
                <p className="text-sm text-purple-800 dark:text-purple-200">
                  Rendered on every request for real-time, user-specific data. Always fresh.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="p-8 bg-zinc-100 dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700">
            ...
            <p className="text-zinc-700 dark:text-zinc-300 leading-relaxed mb-6">
              Whether you&apos;re a founder looking to showcase your startup, an investor seeking
              the next big opportunity, or an enthusiast exploring innovation, StartupDiscovery
              is your platform.
            </p>
            <Link
              href="/"
